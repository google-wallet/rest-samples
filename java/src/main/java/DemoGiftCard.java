...
public class DemoGiftCard {
  public static void main(String[] args) throws Exception {
    ...
    // [START class]
    GenericUrl classUrl = new GenericUrl("https://walletobjects.googleapis.com/walletobjects/v1/giftCardClass/");
    ...
    payload.put("giftCardObjects", new ArrayList<>(Arrays.asList(objectIdMap)));
