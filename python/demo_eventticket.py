...
class DemoEventTicket:
    ...
    # [START class]
    def create_event_ticket_class(self, issuer_id: str,
        ...
        """
        class_url = f'{self.base_url}/eventTicketClass'
    ...
    # [START batch]
    def batch_create_event_ticket_objects(self, issuer_id: str,
                                          class_suffix: str):
        ...
        for _ in range(3):
            ...
            data += json.dumps(batch_event_ticket_object) + '\n\n'
