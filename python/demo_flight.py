...
class DemoFlight:
    ...
    # [START class]
    def create_flight_class(self, issuer_id: str, class_suffix: str) -> str:
        ...
        """
        class_url = f'{self.base_url}/flightClass'
    ...
    # [START batch]
    def batch_create_flight_objects(self, issuer_id: str, class_suffix: str):
        ...
        for _ in range(3):
            ...
            data += json.dumps(batch_flight_object) + '\n\n'
