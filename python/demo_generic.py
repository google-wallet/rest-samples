...
class DemoGeneric:
    ...
    # [START class]
    def create_generic_class(self, issuer_id: str, class_suffix: str) -> str:
        ...
        """
        class_url = f'{self.base_url}/genericClass'
    ...
    # [START batch]
    def batch_create_generic_objects(self, issuer_id: str, class_suffix: str):
        ...
        for _ in range(3):
            ...
            data += json.dumps(batch_generic_object) + '\n\n'
