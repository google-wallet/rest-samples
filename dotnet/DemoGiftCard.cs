...
class DemoGiftCard
{
  ...
  public string UpdateClass(string issuerId, string classSuffix)
  {
    ...
    // Class exists
    GiftCardClass updatedClass = JsonConvert.DeserializeObject<GiftCardClass>(jsonResponse.ToString());
  ...
  public string PatchClass(string issuerId, string classSuffix)
  {
    ...
    GiftCardClass patchBody = new GiftCardClass
    {
  ...
  public string UpdateObject(string issuerId, string objectSuffix)
  {
    ...
    // Object exists
    GiftCardObject updatedObject = JsonConvert.DeserializeObject<GiftCardObject>(jsonResponse.ToString());
  ...
  public string PatchObject(string issuerId, string objectSuffix)
  {
    ...
    // Object exists
    GiftCardObject existingObject = JsonConvert.DeserializeObject<GiftCardObject>(jsonResponse.ToString());
