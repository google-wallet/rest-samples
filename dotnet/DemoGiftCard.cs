...
class DemoGiftCard
{
  ...
  public string CreateGiftCardClass(string issuerId, string classSuffix)
  {
  ...
  public string CreateJWTSaveURL(string issuerId, string classSuffix, string userId)
  {
    ...
    JObject serializedClass = JObject.Parse(
        JsonConvert.SerializeObject(giftCardClass, excludeNulls));
    ...
    JObject serializedObject = JObject.Parse(
        JsonConvert.SerializeObject(giftCardObject, excludeNulls));
    ...
    JObject jwtPayload = JObject.Parse(JsonConvert.SerializeObject(new
    {
      ...
      payload = JObject.Parse(JsonConvert.SerializeObject(new
      {
        ...
        giftCardClasses = new JObject[]
        {
          serializedClass
        },
        giftCardObjects = new JObject[]
        {
          serializedObject
        }
      })),
  ...
  /// <param name="issuerId">The issuer ID being used for this request.</param>
  /// <param name="classSuffix">Developer-defined unique ID for this pass class.</param>
  public async void BatchCreateGiftCardObjects(string issuerId, string classSuffix)
  {
    ...
    for (int i = 0; i < 3; i++)
    {
      ...
      GiftCardObject batchGiftCardObject = new GiftCardObject
      {
        Id = objectId,
        ClassId = $"{issuerId}.{classSuffix}",
        State = "ACTIVE",
      ...
      data += JsonConvert.SerializeObject(batchGiftCardObject) + "\n\n";
    }
    data += "--batch_createobjectbatch--";
