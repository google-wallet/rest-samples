...
class DemoLoyalty
{
  ...
  public string UpdateClass(string issuerId, string classSuffix)
  {
    ...
    // Class exists
    LoyaltyClass updatedClass = JsonConvert.DeserializeObject<LoyaltyClass>(jsonResponse.ToString());
  ...
  public string UpdateObject(string issuerId, string objectSuffix)
  {
    ...
    // Object exists
    LoyaltyObject updatedObject = JsonConvert.DeserializeObject<LoyaltyObject>(jsonResponse.ToString());
