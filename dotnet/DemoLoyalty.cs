...
class DemoLoyalty
{
  ...
  public string CreateLoyaltyClass(string issuerId, string classSuffix)
  {
  ...
  /// <param name="issuerId">The issuer ID being used for this request.</param>
  /// <param name="classSuffix">Developer-defined unique ID for this pass class.</param>
  public async void BatchCreateLoyaltyObjects(string issuerId, string classSuffix)
  {
    ...
    for (int i = 0; i < 3; i++)
    {
      ...
      // See link below for more information on required properties
      // https://developers.google.com/wallet/retail/loyalty-cards/rest/v1/loyaltyobject
      LoyaltyObject batchLoyaltyObject = new LoyaltyObject
      {
        Id = objectId,
        ClassId = $"{issuerId}.{classSuffix}",
        State = "ACTIVE",
      ...
      data += JsonConvert.SerializeObject(batchLoyaltyObject) + "\n\n";
    }
    data += "--batch_createobjectbatch--";
