...
async function main() {
   ...
   */
  const classId = process.env.WALLET_CLASS_ID || 'test-transit-class-id';
  ...
  // [START class]
  const classUrl = 'https://walletobjects.googleapis.com/walletobjects/v1/transitClass/';
  const classPayload = {
    "id": `${issuerId}.${classId}`,
  ...
  // [START object]
  const objectUrl = 'https://walletobjects.googleapis.com/walletobjects/v1/transitObject/';
  const objectPayload = {
    "id": objectId,
