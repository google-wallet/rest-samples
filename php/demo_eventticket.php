...
class DemoEventTicket
{
   ...
   */
  public function createEventTicketClass(string $issuerId, string $classSuffix)
  {
    ...
    try {
      $response = $this->service->eventticketclass->insert($eventTicketClass);
   ...
   * @param string $classSuffix Developer-defined class ID for this class.
   */
  public function batchCreateEventTicketObjects(string $issuerId, string $classSuffix)
  {
    ...
    for ($i = 0; $i < 3; $i++) {
      ...
      $batch->add($this->service->eventticketobject->insert($eventTicketObject));
    }
